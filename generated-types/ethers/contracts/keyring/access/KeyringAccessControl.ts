...
export interface KeyringAccessControlInterface extends utils.Interface {
  functions: {
...
export interface KeyringAccessControl extends BaseContract {
  contractName: "KeyringAccessControl";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KeyringAccessControlInterface;
