...
export interface IKeyringZkVerifierInterface extends utils.Interface {
  functions: {
...
export interface IKeyringZkVerifier extends BaseContract {
  contractName: "IKeyringZkVerifier";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IKeyringZkVerifierInterface;
